                ...
                <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
                    <div class="facts">
                        <div class="facts_left">
                            <img src="{{asset('upload/default/'.$user->profile->image)}}" alt=" " class="img-responsive" />
                        </div>
                        <div class="facts_right">
                            ...
                            {{--<p>Full Name <strong> : </strong>{{$user->profile->name}}</p>
                            <p>Email <strong> : </strong>{{$user->profile->email}}</p>
                            <p>Role <strong> : </strong>{{$user->profile->role_name}}</p>--}}

                            <!--This way works the same -->
                            <p>Full Name <strong> : </strong>{{$profile->user->name}}</p>
                            <p>Email <strong> : </strong>{{$profile->user->email}}</p>
                            <p>Role <strong> : </strong>{{$profile->user->role_name}}</p>
                            <!--End of This way works the same -->

                            <p>Phone <strong> : </strong>{{$user->profile->phone}}</p>
                            <p>Position <strong> : </strong>{{$user->profile->position}}</p>
                            <p>Platform <strong> : </strong>{{$user->profile->platform}}</p>
                            <p>About <strong> : </strong>{{$user->profile->about_me}}</p>
