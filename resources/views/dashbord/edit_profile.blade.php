                            ...
                            <div class="form-body">
                                <form class="form-horizontal" method="POST" action="/edit/{{$profile->id}}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="role" class="form-control" id="role" value="{{$profile->user->role_name}}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="platform" class="form-control" id="role" value="{{$profile->platform}}" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
