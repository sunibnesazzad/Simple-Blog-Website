                            ...
                            <div class="widget-shadow " data-example-id="basic-forms">
                                ...
                                <div class="form-body">
                                    <form class="form-horizontal" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="platform" class="form-control" id="role" value="{{$user->profile->platform}}" disabled>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="form-body">
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            <label for="inputPassword3" class="col-sm-2 control-label">Linked In</label>
                                            <div class="col-sm-9">
                                                <input type="text" name="phone" class="form-control" id="phone" value="" disabled>
                                            </div>
                                        </div>
                                    </form>
                                </div>
