                ...
                <div class="forms" >
                    <div class=" form-grids form-grids-right">
                        <div class="widget-shadow " data-example-id="basic-forms">
                            <div class="form-body">
                                <form class="form-horizontal" method="POST" action="/updates/{{$post->id}}" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    <br>
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-2 control-label">Title Name</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="title" class="form-control" id="title" placeholder="Title Name" value="{!! $post->title !!}">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea type="text" name="body" class="form-control" id="editor1" placeholder="Type detail here." required>{!! $post->body !!}</textarea>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group">
